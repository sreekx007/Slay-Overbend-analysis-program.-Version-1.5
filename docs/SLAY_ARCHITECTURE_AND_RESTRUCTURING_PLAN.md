...
| Plain pipe | ~~0.494% at R=70m / 0.384% at R=85m / 0.316% at R=100m~~ **SUPERSEDED 21 Sep 2026** — the benchmark is the source paper's Abaqus TABLE X: **0.46% (R=70) / 0.38% (R=85) / 0.32% (R=105)**, at **120 MT** and **9 m roller spacing**, 406×21. | The old row matches neither the paper nor any reproducible configuration of the Python program (which gives 0.4800 / 0.3626 / 0.2665 at 8 m spacing, 0.5081 / 0.3777 / 0.2733 at 9 m). Always state R AND tension AND spacing. See `docs/modules/T5_solve_spec.md` §4. |
